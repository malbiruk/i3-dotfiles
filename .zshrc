...
export PATH=$HOME/bin:/usr/local/bin:/home/klim/.local/bin:$PATH
...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting z command-not-found extract)
...
#
alias mic='alsa_in -d hw:C1U -c 1 -r 44100 -p 512 -n 2'
